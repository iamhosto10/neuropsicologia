...
const steps = [
  {
    ...
    description: 'Mira atentamente todas las cartas que están sobre la mesa boca arriba.',
  },
  {
    icon: Hand,
    title: 'Toca dos cartas',
    description: 'Selecciona dos cartas para intentar encontrar una pareja coincidente.',
  },
  {
    icon: Smile,
    title: '¡Celebra!',
    description: 'Si las cartas son iguales, déjalas boca arriba y gana un punto.',
  },
];
  ...
  return (
    ...
    >
      <div className="flex flex-row items-center gap-4">
        ...
        <h2 className="text-2xl font-extrabold text-black">Instrucciones Paso a Paso</h2>
      </div>
      ...
      <div className="mt-8 flex flex-col gap-8 relative">
        ...
        {steps.map((step, index) => (
          <div
            key={step.title}
            className={cn('flex flex-row gap-6 relative z-10 animate-in slide-in-from-bottom-4 fade-in')}
