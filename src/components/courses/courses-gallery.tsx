...
const courses = [
  {
    ...
    description: 'Fomenta la creatividad y habilidades motoras con bloques y juegos de construcción.',
    age: '2-4 años',
    lessons: '8 Lecciones',
  ...
  },
  {
    ...
    description: 'Desarrolla habilidades sociales y de comunicación a través de juegos interactivos.',
    age: '3-5 años',
  ...
  },
  {
    ...
    description: 'Explora el mundo del arte con pintura, dibujo y manualidades.',
    age: '4-6 años',
  ...
  },
  {
    ...
    description: 'Introduce a los niños al ritmo y la música con instrumentos y baile.',
    age: '2-5 años',
    lessons: '8 Lecciones',
  ...
  },
  {
    ...
    description: 'Experimentos divertidos y seguros para despertar la curiosidad científica.',
    age: '5-7 años',
  ...
  },
  {
    ...
    description: 'Fomenta el amor por la lectura con historias y actividades participativas.',
    age: '3-6 años',
    lessons: '10 Lecciones',
    bgColor: 'bg-pink-50',
  },
...
export function CoursesGallery() {
  return (
    <section className="w-full max-w-7xl mx-auto px-4 py-12 md:px-6 md:py-16 lg:py-20">
      {/* Header */}
      <div className="text-center mb-8">
        <h2 className="text-3xl md:text-4xl font-bold text-black">Explora Nuestros Cursos</h2>
      ...
      <div className="mb-12 bg-white rounded-[2rem] shadow-sm p-4">
        <div className="flex flex-wrap lg:flex-nowrap lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex items-center gap-2 w-full lg:w-auto">
            ...
            <Button variant="ghost" className="rounded-full text-black hover:bg-gray-100">
              Limpiar
            </Button>
          </div>
        </div>
      ...
      {/* Courses Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 animate-in fade-in slide-in-from-bottom-8">
        {courses.map((course) => (
          <Card key={course.title} className="bg-white rounded-[2rem] border-none shadow-sm hover:shadow-lg overflow-hidden group transition-transform duration-300 hover:-translate-y-2">
            ...
            <CardContent className="p-6 flex flex-col gap-2">
              ...
              <div className="flex items-center gap-2 mt-4">
                <Badge className="bg-[oklch(var(--brand-pastel-tag))] text-amber-900 rounded-full font-medium hover:bg-orange-200">{course.age}</Badge>
                <Badge className="bg-[oklch(var(--brand-pastel-tag))] text-amber-900 rounded-full font-medium hover:bg-orange-200">{course.lessons}</Badge>
              </div>
            </CardContent>
          </Card>
        ))}
