            ...
            {/* Call to Action: Ver Progreso */}
             <Link
                ...
                className={cn(
                    ...
                    "bg-[var(--brand-mustard)] text-white hover:opacity-90",
            ...
            <SheetContent side="right">
                ...
                <div className="flex flex-col gap-4 mt-6">
                    ...
                    <nav className="flex flex-col gap-2">
                        <Link href="/dashboard/settings" className="flex items-center gap-3 px-4 py-2 hover:bg-muted rounded-md transition-colors">
                            <Settings className="h-5 w-5" />
                            <span>Ajustes</span>
                        </Link>
                        <Link href="/dashboard/help" className="flex items-center gap-3 px-4 py-2 hover:bg-muted rounded-md transition-colors">
                            <HelpCircle className="h-5 w-5" />
                            <span>Ayuda</span>
                        </Link>
                         <Link href="/logout" className="flex items-center gap-3 px-4 py-2 hover:bg-red-100 text-red-600 rounded-md transition-colors mt-2">
